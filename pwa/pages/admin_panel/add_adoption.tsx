                    ...
                    <Form>
                        <div className="md:flex md:items-center mb-6">
                            ...
                            <div className="md:w-2/3">
                                <Field className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" name="user" type="select" />
                        ...
                        <div className="md:flex md:items-center mb-6">
                            ...
                            <div className="md:w-2/3">
                                <Field className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" name="animal" type="select" />
                                {errors.animal && touched.animal ? (
                                    <div className="text-red-500 ml-1/3 absolute">{errors.animal}</div>
                                ) : null}
                            </div>
                        </div>
